  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex items-center justify-center px-4 py-8">
      {prediction ? (
        ...
        <div className="w-full max-w-3xl p-8 bg-white rounded-2xl shadow-xl border border-blue-100">
          <h2 className="text-3xl font-bold text-center text-blue-600 mb-4">
            Upload MRI Image for Lung Cancer Analysis
          </h2>
          <p className="text-center text-gray-600 mb-6">
            Please upload your chest MRI scan image. Our AI will assist in
            analyzing the scan for possible signs of lung cancer. Your data is
            processed securely.
          </p>

          <Dragger
            {...props}
            className="bg-blue-50 border-blue-300 hover:border-blue-500 transition-all"
          >
            ...
            <p className="ant-upload-hint text-gray-500 text-sm">
              Supports a single image file. We do not store any data.
            </p>
          </Dragger>
...
export default LungCancerUpload;
