      ...
      {prediction ? (
        ...
        <div className="w-full max-w-3xl p-8 bg-white rounded-2xl shadow-xl border border-pink-100">
          <h2 className="text-3xl font-bold text-center text-pink-600 mb-4">
            Upload Oral Image for Mouth Cancer Analysis
          </h2>
          <p className="text-center text-gray-600 mb-6">
            Please upload an image showing the inner mouth or oral region. Our
            AI will analyze the image for signs of mouth cancer. All uploads are
            processed securely.
          </p>
...
export default MouthCancerUpload;
